...
class StatsMarket(QWidget):
    def __init__(self, mainWindows):
        ...
        loadUi(directory + "/../ui/stats_market.ui", self)
        ...
        self.mainWindows.setWindowTitle(_("Stats of markets") + " | Betcon v" + mainWindows.version)
        self.translate()
        try:
            self.initData()
        except Exception:
    ...
    def translate(self):
        ...
        header = [_("Market"), _("Sport"), _("Bets"), _("Success"), _("Money Bet"), _("Profit"), _("Stake"), _("Quota")]
    ...
    def initData(self):
        ...
        for i in data:
            ...
            profit_val = float(str(i[5]).rstrip('€$£ ').replace(',', '.') or '0')
